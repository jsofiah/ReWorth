...
// Hitung TOTAL PENDAPATAN per produk (berdasarkan total_bayar)
$produkTerjual = [];
...
// Ambil SEMUA produk penjual untuk ditampilkan di sumbu X
$semuaNamaProduk = array_column($produkList, 'nama_produk');

// Data pendapatan untuk setiap produk (0 jika tidak laku)
$dataPenjualan = [];
...
<body>
    ...
    <div class="main-wrap">
        ...
        <div class="action-bar-wrap">
            <div class="action-bar">
                ...
                <?php if ($pesananMenunggu > 0): ?>
                    <button class="btn-notif" onclick="window.location.href='pesanan.php?status=menunggu_konfirmasi'">
        ...
        <?php if ($langgananStatus['warning_message']): ?>
<div class="alert alert-<?= $langgananStatus['warning_type'] ?> alert-dismissible fade show m-3" role="alert">
    <div class="d-flex gap-2 align-items-center">
        <i class="bi bi-exclamation-triangle-fill fs-5"></i>
        <span><?= $langgananStatus['warning_message'] ?></span>
    </div>
