...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $foto_path = $pengguna['foto_profil'] ?? '';
    ...
    // Update ke database
    $updateUrl = $supabaseUrl . "/rest/v1/pengguna?id_pengguna=eq." . $idPengguna;
    $ch = curl_init();
    ...
    if ($httpCode === 200 || $httpCode === 204) {
        $logData = [
            ...
            'aktivitas' => 'Mengedit pengguna: ' . $nama,
        ...
        if ($logHttpCode !== 200 && $logHttpCode !== 201 && $logHttpCode !== 204) {
            error_log("Gagal menyimpan log: HTTP $logHttpCode - Response: $logResponse");
        }
...
<body>
        ...
        <div class="content-area">
            <div class="form-container">
                <div class="form-section">
                    ...
                    <form id="penggunaForm" enctype="multipart/form-data">
                        <div class="row-2cols">
                            <div class="form-group">
                                <label class="form-label">Nama Lengkap <span class="text-danger">*</span></label>
                                <input type="text" class="form-control-custom" id="nama_lengkap" placeholder="Masukkan nama lengkap" required value="<?= htmlspecialchars($pengguna['nama_lengkap'] ?? '') ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Email <span class="text-danger">*</span></label>
                                <input type="email" class="form-control-custom" id="email" placeholder="contoh@email.com" required value="<?= htmlspecialchars($pengguna['email'] ?? '') ?>">
                            </div>
                        </div>
                        ...
                        <div class="row-2cols">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control-custom" id="no_telepon" placeholder="628xxxxxxxxxx" value="<?= htmlspecialchars($pengguna['no_telepon'] ?? '') ?>">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control-custom" id="alamat_detail" rows="2" placeholder="Masukkan alamat lengkap"><?= htmlspecialchars($pengguna['alamat_detail'] ?? '') ?></textarea>
                        </div>
                        ...
                        <div class="row-3cols">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="id_wilayah" value="<?= htmlspecialchars($pengguna['id_wilayah'] ?? '') ?>">
                            </div>
                        </div>
                        ...
                        <div class="row-3cols">
                            <div class="form-group">
                                ...
                                <div class="file-upload-wrapper">
                                    <label class="file-upload-label">
                                        ...
                                        <span id="fileName"><?= !empty($pengguna['foto_profil']) ? 'Ganti foto' : 'Pilih file foto' ?></span>
                                ...
                                <div class="image-preview" id="imagePreview">
                                    <?php if (!empty($pengguna['foto_profil'])): ?>
                                        <div class="preview-item">
                                            <img src="<?= htmlspecialchars(getSupabaseImageUrl($pengguna['foto_profil'])) ?>" alt="Preview">
                            ...
                            <div class="form-group">
                                ...
                                <div style="position: relative;">
                                    ...
                                    <input type="number" class="form-control-custom" id="saldo_tabungan" placeholder="0" value="<?= $pengguna['saldo_tabungan'] ?? 0 ?>" style="padding-left: 48px;">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Poin</label>
                                <input type="number" class="form-control-custom" id="poin" placeholder="0" value="<?= $pengguna['poin'] ?? 0 ?>">
                            </div>
                        </div>
                        
                        <div class="form-actions">
                            <button type="button" class="btn-cancel" onclick="window.location.href='kelola_akun.php?tab=pengguna'">Batal</button>
    ...
    <script>
        ...
        const currentIdWilayah = "<?= $pengguna['id_wilayah'] ?? '' ?>";
        const currentKecamatan = "<?php 
            $currentKec = '';
            if (!empty($pengguna['id_wilayah']) && !empty($wilayahList)) {
                foreach ($wilayahList as $w) {
                    if ($w['id_wilayah'] == $pengguna['id_wilayah']) {
        ...
        function removeExistingImage() {
            ...
            // Tambahkan input hidden untuk menandai bahwa foto akan dihapus
            ...
            if (!hiddenInput) {
                ...
                hiddenInput.value = '1';
                document.getElementById('penggunaForm').appendChild(hiddenInput);
            }
        }
        ...
        document.getElementById('penggunaForm').onsubmit = async function(e) {
            e.preventDefault();
            ...
            try {
                ...
                if (data.success) {
                    setTimeout(() => {
                        window.location.href = 'kelola_akun.php?tab=pengguna';
                    }, 2000);
                }
            } catch (error) {
