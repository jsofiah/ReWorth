<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $ch = curl_init($supabaseUrl . "/rest/v1/role");
        ...
        if ($httpCode === 201 || $httpCode === 200 || $httpCode === 204) {
            ...
            $logData = [
                ...
                'aktivitas' => 'Menambahkan data role: ' . $nama_role,
                'tabel_terkait' => 'role',
                'id_data' => '',
            ];
            ...
            echo json_encode(['success' => false, 'message' => 'Gagal menambahkan data role']);
        }
        exit;
    }
?>
...
<head>
    ...
    <title>Tambah Role - Kelola Data Master</title>
                ...
                <div class="form-section">
                    ...
                    <form id="roleForm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-custom" id="nama_role" placeholder="Masukkan nama role" required>
