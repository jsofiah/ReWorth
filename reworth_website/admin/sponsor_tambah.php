<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $url = $supabaseUrl . "/rest/v1/sponsor";
        ...
        if ($httpCode === 201 || $httpCode === 200) {
            ...
            $sponsorId = $responseData[0]['id_sponsor'] ?? null;
            
            $logData = [
                'id_admin' => $_SESSION['id_admin'] ?? '',
                'aktivitas' => 'Menambahkan sponsor baru: ' . $nama_sponsor,
            ...
            echo json_encode(['success' => true, 'message' => 'Sponsor berhasil ditambahkan']);
        } else {
            echo json_encode(['success' => false, 'message' => 'Gagal menambahkan sponsor. Silakan coba lagi.']);
        }
        exit;
    }
?>
                    ...
                    <form id="sponsorForm">
                        <div class="row-2cols">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control-custom" id="nama_sponsor" placeholder="Masukkan nama sponsor" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-custom" id="kontak" placeholder="Masukkan nomor telepon atau email kontak" required>
                            <small class="text-muted" style="font-size: 11px;">Contoh: 08123456789 atau email@example.com</small>
                        </div>
