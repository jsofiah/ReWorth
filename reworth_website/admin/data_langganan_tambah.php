<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $data = [
            ...
            'status' => $status,
            'bukti_pembayaran' => $foto_path,
        ];
        
        $ch = curl_init($supabaseUrl . "/rest/v1/langganan");
        ...
        if ($httpCode === 201 || $httpCode === 200 || $httpCode === 204) {
            ...
            echo json_encode(['success' => true, 'message' => 'Langganan berhasil ditambahkan']);
        } else {
            echo json_encode(['success' => false, 'message' => 'Gagal menambahkan data langganan']);
        }
        exit;
    }
?>
...
<head>
    ...
    <title>Tambah Langganan - Kelola Data Master</title>
                    ...
                    <form id="langgananForm" enctype="multipart/form-data">
                        ...
                        <div class="row-2cols">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control-custom" id="tanggal_mulai" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Tanggal Selesai <span class="text-danger">*</span></label>
                                <input type="date" class="form-control-custom" id="tanggal_selesai" readonly style="background-color: #f3f4f6; cursor: not-allowed;" required>
                                <small class="text-muted" style="font-size: 11px;">Otomatis 3 bulan setelah tanggal mulai</small>
                            </div>
                        </div>
                        ...
                        <div class="row-2cols">
                            <div class="form-group">
                                ...
                                <div style="position: relative;">
                                    ...
                                    <input type="number" class="form-control-custom" id="jumlah_bayar" placeholder="0" value="0" style="padding-left: 48px;" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="file-upload-wrapper">
                                    <label class="file-upload-label">
                                        ...
                                        <span id="fileName">Pilih file bukti pembayaran</span>
        ...
        function previewImage(input) {
            ...
            if (input.files && input.files[0]) {
                if (input.files[0].size > 2 * 1024 * 1024) {
                    ...
                    input.value = '';
                    document.getElementById('fileName').textContent = 'Pilih file bukti pembayaran';
                    return;
                }
