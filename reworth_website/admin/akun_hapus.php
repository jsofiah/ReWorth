...
function hapusPengguna($supabaseUrl, $supabaseKey, $id) {
    ...
    // Hapus user dari Auth jika ada (opsional, karena mungkin cascade)
...
// Ambil nama data untuk log sebelum dihapus
switch($tab) {
    case 'pengguna':
