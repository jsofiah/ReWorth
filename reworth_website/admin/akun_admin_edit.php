            ...
            <div class="form-container">
                <div class="form-section">
                    <div class="inside-header">
                        <h2>Edit <?= htmlspecialchars($roleTitle) ?></h2>
                    </div>
                    <form id="adminForm" enctype="multipart/form-data">
                        <div class="row-2cols">
                            <div class="form-group">
                                <label class="form-label">Nama Lengkap <span class="text-danger">*</span></label>
                                <input type="text" class="form-control-custom" id="nama_admin" placeholder="Masukkan nama lengkap" required value="<?= htmlspecialchars($admin['nama_admin'] ?? '') ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Email <span class="text-danger">*</span></label>
                                <input type="email" class="form-control-custom" id="email" placeholder="contoh@email.com" required value="<?= htmlspecialchars($admin['email'] ?? '') ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload-wrapper">
                                <label class="file-upload-label">
                                    ...
                                    <span id="fileName"><?= !empty($admin['foto_profil']) ? 'Ganti foto' : 'Pilih file foto' ?></span>
                            ...
                            <div class="image-preview" id="imagePreview">
                                <?php if (!empty($admin['foto_profil'])): ?>
                                    <div class="preview-item">
                                        <img src="<?= htmlspecialchars(getSupabaseImageUrl($admin['foto_profil'])) ?>" alt="Preview">
    ...
    <script>
        ...
        function removeExistingImage() {
            ...
            if (!hiddenInput) {
                ...
                hiddenInput.value = '1';
                document.getElementById('adminForm').appendChild(hiddenInput);
            }
        }
