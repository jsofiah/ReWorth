<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $ch = curl_init($supabaseUrl . "/rest/v1/wilayah");
        ...
        if ($httpCode === 201 || $httpCode === 200 || $httpCode === 204) {
            ...
            $logData = [
                ...
                'aktivitas' => 'Menambahkan data wilayah: RW ' . $rw . ' - ' . $kelurahan,
            ...
            echo json_encode(['success' => true, 'message' => 'Wilayah berhasil ditambahkan']);
        } else {
            echo json_encode(['success' => false, 'message' => 'Gagal menambahkan data wilayah']);
        }
        exit;
    }
?>
...
<head>
    ...
    <title>Tambah Wilayah - Kelola Data Master</title>
                    ...
                    <form id="wilayahForm">
                        <div class="row-2cols">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control-custom" id="kecamatan" placeholder="Contoh: Blimbing" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Kelurahan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control-custom" id="kelurahan" placeholder="Contoh: Arjosari" required>
                            </div>
                        </div>
                        ...
                        <div class="row-2cols">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control-custom" id="rw" placeholder="Contoh: 01" required>
                                <small class="text-muted" style="font-size: 11px;">Masukkan nomor RW (tanpa tulisan RW)</small>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Kota <span class="text-danger">*</span></label>
                                <input type="text" class="form-control-custom" id="kota" placeholder="Contoh: Kota Malang" required>
                            </div>
                        </div>
