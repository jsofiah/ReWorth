<?php
    ...
    function getLogDLH($supabaseUrl, $supabaseKey, $page = 1, $per_page = 10) {
    ...
    function getTotalLogDLH($supabaseUrl, $supabaseKey) {
    ...
    $allLogs = getLogDLH($supabaseUrl, $supabaseKey, $page, $per_page);
    $total = getTotalLogDLH($supabaseUrl, $supabaseKey);
