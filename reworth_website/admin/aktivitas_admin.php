<?php
    ...
    function getLogAdmin($supabaseUrl, $supabaseKey, $page = 1, $per_page = 10) {
    ...
    function getTotalLogAdmin($supabaseUrl, $supabaseKey) {
    ...
    $allLogs = getLogAdmin($supabaseUrl, $supabaseKey, $page, $per_page);
    $total = getTotalLogAdmin($supabaseUrl, $supabaseKey);
