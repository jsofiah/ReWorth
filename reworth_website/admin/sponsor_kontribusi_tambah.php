<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($id_sponsor) || empty($jenis_kontribusi) || empty($tanggal)) {
        ...
        $url = $supabaseUrl . "/rest/v1/kontribusi_sponsor";
        ...
        if ($httpCode === 201 || $httpCode === 200) {
            ...
            $kontribusiId = $responseData[0]['id_kontribusi'] ?? null;
            
            $logData = [
                'id_admin' => $_SESSION['id_admin'] ?? '',
                'aktivitas' => 'Menambahkan kontribusi ' . $jenis_kontribusi . ' untuk sponsor',
                'tabel_terkait' => 'kontribusi_sponsor',
                'id_data' => $kontribusiId,
            ];
            ...
            echo json_encode(['success' => true, 'message' => 'Kontribusi sponsor berhasil ditambahkan']);
        } else {
            echo json_encode(['success' => false, 'message' => 'Gagal menambahkan kontribusi. Silakan coba lagi.']);
        }
        exit;
    }
...
<head>
    ...
    <title>Admin – Tambah Kontribusi Sponsor</title>
...
<body>
            ...
            <div class="form-container">
                <div class="form-section">
                    <div class="inside-header">
                        <h2>Tambah Kontribusi Sponsor</h2>
                    </div>
                    ...
                    <form id="kontribusiForm">
                        ...
                        <div id="fieldBarang" class="dynamic-field">
                            <div class="row-2cols">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control-custom" id="nama_barang" placeholder="Masukkan nama barang">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Jumlah Barang</label>
                                    <input type="number" class="form-control-custom" id="jumlah_barang" placeholder="Jumlah barang" min="1" value="1">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="fieldUang" class="dynamic-field">
                            <div class="form-group">
                                ...
                                <input type="integer" class="form-control-custom" id="nominal_uang" placeholder="Masukkan nominal uang" min="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control-custom" id="keterangan" rows="3" placeholder="Masukkan keterangan tambahan (opsional)"></textarea>
                        </div>
    ...
    <script>
        ...
        function toggleDynamicFields() {
            ...
            document.getElementById('nominal_uang').value = '';
