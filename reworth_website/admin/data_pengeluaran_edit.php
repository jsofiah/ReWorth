<?php
    ...
    $idPengeluaran = isset($_GET['id']) ? $_GET['id'] : '';

    if (empty($idPengeluaran)) {
        echo '<div class="alert alert-danger m-3">ID Pengeluaran tidak ditemukan.</div>';
        exit;
    }
    ...
    function getPengeluaranById($supabaseUrl, $supabaseKey, $id) {
        $ch = curl_init($supabaseUrl . "/rest/v1/pengeluaran?id_pengeluaran=eq.$id&select=*");
    ...
    $pengeluaran = getPengeluaranById($supabaseUrl, $supabaseKey, $idPengeluaran);

    if (!$pengeluaran) {
        echo '<div class="alert alert-danger m-3">Data pengeluaran tidak ditemukan.</div>';
        exit;
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $url = $supabaseUrl . "/rest/v1/pengeluaran?id_pengeluaran=eq." . $idPengeluaran;
        ...
        if ($httpCode === 200 || $httpCode === 204) {
            ...
            $logData = [
                ...
                'aktivitas' => 'Mengedit data pengeluaran: ' . $keterangan,
                'tabel_terkait' => 'pengeluaran',
                'id_data' => $idPengeluaran,
            ];
            ...
            echo json_encode(['success' => false, 'message' => 'Gagal mengupdate data pengeluaran']);
        }
        exit;
    }
?>
...
<head>
    ...
    <title>Edit Pengeluaran - Kelola Data Master</title>
                ...
                <div class="form-section">
                    ...
                    <form id="pengeluaranForm">
                        <div class="form-group">
                            ...
                            <textarea class="form-control-custom" id="keterangan" rows="3" placeholder="Masukkan keterangan pengeluaran..." required><?= htmlspecialchars($pengeluaran['keterangan'] ?? '') ?></textarea>
                        ...
                        <div class="row-2cols">
                            <div class="form-group">
                                ...
                                <div style="position: relative;">
                                    ...
                                    <input type="number" class="form-control-custom" id="jumlah" placeholder="0" value="<?= $pengeluaran['jumlah'] ?? 0 ?>" style="padding-left: 48px;" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control-custom" id="tanggal" value="<?= $pengeluaran['tanggal'] ?? date('Y-m-d') ?>" required>
